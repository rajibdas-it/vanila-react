        ...
        <div className="shadow-md rounded-lg bg-slate-800 border-slate-700">
            ...
            <div className="px-5 py-5">
                <div className="flex items-center justify-between mt-5">
                    ...
                    <span className="text-xl font-medium text-teal-500">Total: ৳ {productPrice}</span>
                </div>
                <div className="flex items-center justify-between mt-5">
                    <span className="text-2xl font-bold text-slate-300">৳ {qty * productPrice}</span>
                    <a
                        onClick={addToCart}
                        href="#"
...
{/* button er onclick theke jodi direct state set korte chai onClick = {() => setQty(qty + 1)} */ }
{/* call function in react < Product /> */ }
